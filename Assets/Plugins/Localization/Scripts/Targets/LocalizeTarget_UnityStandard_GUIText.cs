...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_GUIText : LocalizeTarget<UnityEngine.UI.Text>
    {
        ...
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.BeforeSceneLoad)] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<UnityEngine.UI.Text, LocalizeTarget_UnityStandard_GUIText>() { Name = "UnityEngine.UI.Text", Priority = 100 }); }
        ...
        public override void DoLocalize(Localize cmp, string mainTranslation, string secondaryTranslation)
        {
            ...
            {
                if (cmp.CorrectAlignmentForRTL && mTarget.alignment != (TextAnchor) TextAlignment.Center)
