...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_GUITexture : LocalizeTarget<UnityEngine.UI.Image>
    {
        ...
        [RuntimeInitializeOnLoadMethod] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<UnityEngine.UI.Image, LocalizeTarget_UnityStandard_GUITexture>() { Name = "UnityEngine.UI.Image", Priority = 100 }); }
        ...
        {
            primaryTerm = mTarget.sprite.texture ? mTarget.sprite.texture.name : string.Empty;
            secondaryTerm = null;
        }
        ...
        public override void DoLocalize(Localize cmp, string mainTranslation, string secondaryTranslation)
        {
            ...
            Texture Old = mTarget.sprite.texture;
