...
public sealed partial class FlagConfig :  Bright.Config.BeanBase 
{
    public FlagConfig(JSONNode _json) 
    {
    ...
    public FlagConfig(string id, string name, string image, int water_need, int fertile_need, int care_need, int harvest, int price ) 
    {
        this.Id = id;
        this.Name = name;
        this.Image = image;
    ...
    public static FlagConfig DeserializeFlagConfig(JSONNode _json)
    {
        return new FlagConfig(_json);
    }
    ...
    public const int __ID__ = 1988889070;
